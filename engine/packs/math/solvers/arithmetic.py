...
_OP_NARRATION: dict[str, str] = {
    ...
    "expand_power": "累乗を、同じ数をかけ合わせる積に書き直す。",
    "identify_base_scope": "指数がどの範囲にかかっているか（かっこの有無）を見分ける。",
    "evaluate_each_power": "それぞれの累乗を、符号に注意して計算する。",
...
_OP_PHRASE: dict[str, str] = {
    ...
    "expand_power": "累乗を積に書き直す",
    "identify_base_scope": "指数のかかる範囲を見分ける",
