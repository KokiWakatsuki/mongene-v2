...
_ASKED_PROMPTS: dict[str, str] = {
    ...
    "choice": "正しいものを選びなさい。",
    # 読み取る
    # **定型文は、その asked を使う全セルで真であること。** 本文はどれも自分で
    # 問いを言い切っているので、問いの側が別のことを言うと食い違いになる。
    # 「点の座標を読み取りなさい。」は、点をとる問題・数直線の目もりを読む問題・
    # 格子点を答える問題にも付いていた（13セル中7セルで場面と違った）。
    "read_point": "答えなさい。",
    "read_table": "読み取って答えなさい。",
    "read_box_plot": "箱ひげ図から読み取って答えなさい。",
    # 比例定数を答えるセルにも付いていたので、読み取る対象は本文に任せる。
    "read_slope_intercept": "グラフから読み取って答えなさい。",
    ...
    # 見取図・投影図・展開図・切り口の図が同じ asked を共有している（9セル中、
    # 実際に見取図なのは2セルだけだった）。どれにも当てはまる言い方にする。
    "draw_solid": "図をかきなさい。",
    "draw_transformed_polygon": "移した図形をかきなさい。",
    "draw_tree_diagram": "樹形図をかきなさい。",
    # 線分でかくセルと、折れ線のグラフをかくセルが共有している。
    "draw_segment": "グラフをかきなさい。",
