...
_READ_TARGET_TEXT: dict[str, str] = {
    ...
    "min_max": "最小値と最大値の値",
    # 入試対策（exam_l7 Lv2）は台帳 example どおり4つまとめて読む。
    # 2つ組のままにしていたので、場面も読み取り対象も g2_l56 Lv1 と同じになり、
    # **問題文が完全に一致する問題が 66 問**出ていた。
    "q1_median_q3_max": "第一四分位数・中央値・第三四分位数・最大値の値",
    "min_q1_median_q3": "最小値・第一四分位数・中央値・第三四分位数の値",
}
