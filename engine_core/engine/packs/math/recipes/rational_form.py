...
# **循環節は3桁まで。** 6桁まで許していたので「13/14 → 0.92̇85714̇」という、
# 手で書き出すのに7回わり算を続ける式が出ていた（教科書は 1/3・1/7・5/6 の
# ように 1〜3桁）。分母の上限（99）はそのまま——壊れていたのは循環節の
# 長さであって分母の広さではない（原則⓪: 答えの大きさで測る）。
_MAX_REPEATING_PERIOD = 3
