...
_RULE_MAPS: dict[str, dict[str, tuple[str, list[str]]]] = {
    ...
    "congruence_conditions": {
        "all_three": (
            ...
            [
                "三組の角がそれぞれ等しいことだけで、合同であるといえる",
                "二組の辺がそれぞれ等しいことだけで、合同であるといえる",
            ],
        ),
    },
    ...
    "right_triangle_congruence_conditions": {
        "both": (
            ...
            [
                "一つの鋭角と他の一辺がそれぞれ等しいことだけで、合同であるといえる",
                "斜辺の長さだけが等しいことで、合同であるといえる",
            ],
        ),
    },
    ...
    "parallelogram_conditions": {
        "all_five": (
            ...
            [
                "対角線の長さが等しいことだけで、平行四辺形であるといえる",
                "一組の対辺が平行であることだけで、平行四辺形であるといえる",
            ],
        ),
    },
