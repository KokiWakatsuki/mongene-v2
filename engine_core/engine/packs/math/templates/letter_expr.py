...
LF_OPPOSITE_QUANTITY_V1 = "{{ given.statement }}を、符号を使って表せ。"
# g1_l10.knowledge Lv2: 数の集合が四則について閉じているかを判別する
LF_SET_CLOSURE_V1 = "{{ given.statement }}。あてはまるものを選べ。"
# g1_l60.knowledge Lv2: 測定値の有効数字が何けたかを判別する
LF_SIGFIG_JUDGE_V1 = (
    "ある量を測定して {{ given.statement }} と表した。"
    "この測定値の有効数字は何けたか、正しいものを1つ選べ。"
)
# g1_l12.knowledge Lv2: 与えられた文字式が表す数量の意味を解釈する
LF_INTERPRET_EXPR_V1 = "{{ given.statement }} は何を表していますか。正しいものを1つ選べ。"
