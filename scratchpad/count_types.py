...
実行: PYTHONPATH=. .venv/bin/python scratchpad/count_types.py [seeds]
"""
...
def main() -> None:
    ...
    with open("scratchpad/types.json", "w", encoding="utf-8") as fh:
        json.dump(per_cell, fh, ensure_ascii=False, indent=1)
    print("\n型ごとの代表 seed を scratchpad/types.json に書いた。")
